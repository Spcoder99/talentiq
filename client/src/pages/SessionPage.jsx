...
import { Loader2Icon, LogOutIcon, PhoneOffIcon, Video } from 'lucide-react';
...
function SessionPage() {
    ...
    const handleLanguageChange = (e) => {
        ...
        // use problem - specific starter code for the newly selected language
    ...
    const handleEndSession = () => {
        if (confirm("Are you sure you want to end the session? All participants will be notified.")) {
            // This will navigate to dashboard after session is ended
